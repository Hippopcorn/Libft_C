...
#    Updated: 2025/11/18 14:53:50 by evarache         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC := ft_atoi.c ft_isalnum.c ft_isdigit.c ft_memchr.c ft_memmove.c ft_strchr.c ft_strjoin.c ft_strlen.c ft_strrchr.c ft_tolower.c \
...
ft_calloc.c ft_isascii.c ft_itoa.c ft_memcpy.c ft_split.c ft_striteri.c ft_strlcpy.c ft_strnstr.c ft_substr.c ft_putchar_fd.c \
